function [u,E]=energia(t0,tf,nt,a,b,nx,ci,cca,ccb,lamb)
%function [u,E]=energia(t0,tf,nt,a,b,nx,ci,cca,ccb,lamb)
...
%[u,E]=energia(0,100000,500000,0,1.5,150,'80*x.^2-20*x+50','50','200',1,1,a');
%a=2*[13.1*ones(25,1);130*ones(50,1);60*ones(50,1);13.1*ones(25,1)].*10^-6
...
ccb=inline(ccb,'t');
cca=cca(t); ccb=ccb(t);
  %Si queremos ver paso a paso la sol.
