...
%hi=imagesc(x,y,u);
hi=surf(x,y,u);
set(hi,'EdgeColor','none','FaceColor',[0 1 1]);
%colorbar;
%set(ha,'clim',[-1 1]);
axis equal;
lighting phong;
...
% to avi:
movie2avi(F,'surf_mov','compression','Cinepak','fps',20); % uncoment this to save the movie to avi file
...
imwrite(im,map,'surf_gif.gif','DelayTime',0,'LoopCount',inf) %g443800
