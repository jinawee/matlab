...
% to avi:
movie2avi(F,'refraction_mov','compression','Cinepak','fps',20); % uncoment this to save the movie to avi file
...
imwrite(im,map,'refraction_gif.gif','DelayTime',0,'LoopCount',inf) %g443800
